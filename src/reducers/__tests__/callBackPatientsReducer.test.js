...
describe("Callback Patients Reducer", () => {
  it("should return default state", () => {
    const newState = callbackPatientsReducer(INITIAL_STATE, {});
    expect(newState).toEqual(INITIAL_STATE);
  });

  it("should update the state on loading", () => {
    const newState = callbackPatientsReducer(INITIAL_STATE, {
      type: FETCH_CALLBACK_PATIENTS_LOADING,
    });
  ...
  it("should update the state on failed", () => {
    ...
    expect(newState).toEqual({
      ...
      loading: false,
      loaded: true,
      error: "Error in loading callback patients, please try again.",
    });
  });
});
